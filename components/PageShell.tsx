...
export async function PageShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="page-3d page-mesh relative isolate min-h-screen overflow-x-hidden bg-[#f5f7fb] pb-[calc(5.25rem+env(safe-area-inset-bottom))] text-zinc-950 sm:pb-0">
      <CampusSignalScene />
      <InterfaceMotion />
      <Navbar user={user} />
